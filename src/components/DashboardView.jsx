    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">{t.welcome}, <span className="text-amber-600 dark:text-amber-500 font-semibold">{currentUser?.name || "User"}</span>.</p>
        </div>
