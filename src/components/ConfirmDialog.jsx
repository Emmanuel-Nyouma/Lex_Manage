  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div
        ...
        aria-modal="true"
        className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-2xl shadow-2xl p-6 border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-200"
      >
        ...
        {description && (
          <p id="confirm-dialog-description" className="text-slate-600 dark:text-slate-300 dark:text-slate-400 text-sm mb-6 font-medium">
            {description}
          </p>
        )}
