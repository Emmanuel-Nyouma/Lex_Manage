...
import { X, Check, FileText, User, Calendar as CalendarIcon, Gavel, Hash, Upload, Loader2, Paperclip, ChevronDown } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  Initial Status <span className="text-red-500 ml-1" aria-hidden="true">*</span>
                </label>
                <div className="relative group">
                  ...
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-slate-500 dark:text-slate-300 group-focus-within:text-amber-500">
